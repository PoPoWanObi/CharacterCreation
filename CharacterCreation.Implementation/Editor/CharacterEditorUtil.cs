...
namespace CharacterCreation.Implementation.Editor;

public static class CharacterEditorUtil
{
    public static CharacterEditorDelegateRef GetDelegateRefs() => new(
        UnitEditorFunctions.EditUnit,
        UnitEditorFunctions.RenameUnit,
        UnitEditorFunctions.UndoEdit,
        UnitEditorFunctions.UndoRename,
    ...
    public static void ApplyCharacterChanges(CharacterObject character, BodyProperties properties, int race,
        bool isFemale, BodyPropertyType editorPropertyType = default)
    {
        // apply age changes
