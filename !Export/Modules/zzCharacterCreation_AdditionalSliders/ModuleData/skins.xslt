<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match='skins/race[@id="human"]/skin[@name="man"]/deform_keys/deform_key[@id="weight"]'>
    ...
    <xsl:template match='skins/race[@id="human"]/skin[@name="woman"]/deform_keys/deform_key[@id="weight"]'>
        <deform_key id="TorsoBelly" key_time_point="64" name="Belly Size" group_id="0">
            <bone_scales>
    ...
    <xsl:template match='skins/race[@id="human"]/skin[@name="kid_2_male"]/deform_keys/deform_key[@id="weight"]'>
        <deform_key id="TorsoBelly" key_time_point="64" name="Belly Size" group_id="0">
            <bone_scales>
    ...
    <xsl:template match='skins/race[@id="human"]/skin[@name="kid_2_female"]/deform_keys/deform_key[@id="weight"]'>
        <deform_key id="TorsoBelly" key_time_point="64" name="Belly Size" group_id="0">
            <bone_scales>
                <bone_scale bone_type="biped_spine_1" axis="x" key_min="0.8" key_max="1.2" />
                <bone_scale bone_type="biped_spine_1" axis="y" key_min="0.8" key_max="1.2" />
    ...
    <xsl:template match='skins/race[@id="human"]/skin[@name="kid_1_male"]/deform_keys/deform_key[@id="weight"]'>
        <deform_key id="TorsoBelly" key_time_point="64" name="Belly Size" group_id="0">
            <bone_scales>
                <bone_scale bone_type="biped_spine_1" axis="x" key_min="0.8" key_max="1.2" />
                <bone_scale bone_type="biped_spine_1" axis="y" key_min="0.8" key_max="1.2" />
    ...
    <xsl:template match='skins/race[@id="human"]/skin[@name="kid_1_female"]/deform_keys/deform_key[@id="weight"]'>
        <deform_key id="TorsoBelly" key_time_point="64" name="Belly Size" group_id="0">
            <bone_scales>
                <bone_scale bone_type="biped_spine_1" axis="x" key_min="0.8" key_max="1.2" />
                <bone_scale bone_type="biped_spine_1" axis="y" key_min="0.8" key_max="1.2" />
    ...
    <xsl:template match='skins/race[@id="human"]/skin[@name="kid_3_male"]/deform_keys/deform_key[@id="weight"]'>
        <deform_key id="TorsoBelly" key_time_point="64" name="Belly Size" group_id="0">
            <bone_scales>
                <bone_scale bone_type="biped_spine_1" axis="x" key_min="0.8" key_max="1.2" />
                <bone_scale bone_type="biped_spine_1" axis="y" key_min="0.8" key_max="1.2" />
    ...
    <xsl:template match='skins/race[@id="human"]/skin[@name="kid_3_female"]/deform_keys/deform_key[@id="weight"]'>
        <deform_key id="TorsoBelly" key_time_point="64" name="Belly Size" group_id="0">
            <bone_scales>
                <bone_scale bone_type="biped_spine_1" axis="x" key_min="0.8" key_max="1.2" />
                <bone_scale bone_type="biped_spine_1" axis="y" key_min="0.8" key_max="1.2" />
